...
public:
   ...
   void dumpregs (unsigned ins);	// Dumps current register state
   ...
   void pushInROB(unsigned destReg);
   void popFromROB();
	void printROB();
   bool inROB(unsigned srcReg);
