...
#define SIGN_EXTEND_IMM(x)   do { x <<= 16; x >>= 16; } while (0)
   ...
   case 0:
      ...
      while(notInROB(i.reg.rs) && notInROB(i.reg.rt)) PAUSE(1);
   ...
   case 9:			// addiu
      ...
      while(notInROB(i.imm.rs)) PAUSE(1);
      pushInROB(_decodedDST);
   ...
   case 4:			// beq
      ...
      while(notInROB(i.imm.rs) && notInROB(i.imm.rt)) PAUSE(1);
   ...
   case 1:
	 ...
	 break;
      ...
      while(notInROB(i.reg.rs)) PAUSE(1);
   ...
   case 0x11:			// floating-point
      ...
      case 4:			// mtc1
         ...
         while(notInROB(i.freg.ft)) PAUSE(1);
         // pushInROB(_decodedDST);
	 break;
